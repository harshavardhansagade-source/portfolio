...
export default function Footer() {
  return (
    <footer className="bg-[#F7F9F8] border-t border-[#111111]/8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src={logo} alt="Logo" className="w-9 h-9 object-contain" />
              <span className="font-semibold text-[#111111] text-lg">Harshavardhan</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-[#111111] mb-4">Quick Links</h4>
            <ul className="space-y-2">
              {[['home','Home'],['system','The System'],['results','Results'],['pricing','Pricing'],['about','About']].map(([id, label]) => (
                <li key={id}>
                  <button onClick={() => scrollTo(id)} className="text-[#111111]/45 hover:text-[#111111] text-sm transition-colors">
                    {label}
                  </button>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-[#111111]/35 text-xs">DM for coaching enquiries</p>
          </div>
        </div>

        <div className="border-t border-[#111111]/8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#111111]/35 text-sm">© 2024 Harshavardhan Fitness. All rights reserved.</p>
          <p className="text-[#111111]/35 text-sm">Built for transformations that last.</p>
        </div>
      </div>
    </footer>
  )
