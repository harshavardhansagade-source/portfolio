...
const inputClass = `
  w-full bg-[#161616] border border-white/8 rounded-2xl px-4 py-3.5
  text-white placeholder-zinc-700 text-sm
    ...
    <section id="contact" className="py-24 bg-[#090909]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-zinc-500 text-lg">Have a question? Fill the form and I'll get back to you.</p>
        </motion.div>
        ...
        <motion.form
          ...
          className="bg-[#141414] border border-white/6 rounded-3xl p-8 space-y-5"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label className="block text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-2">Name</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-2">Email</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-2">Subject</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-2">Message</label>
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 py-4 px-8 bg-green-600 hover:bg-green-500 text-white font-bold rounded-full hover:shadow-xl hover:shadow-green-500/20 transition-all duration-300 hover:-translate-y-0.5 text-sm uppercase tracking-wider"
          >
